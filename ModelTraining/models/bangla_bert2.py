...
class MyBanglaBert2(BertPreTrainedModel):
...
class BanglaBERT2(torch.nn.Module):
    def __init__(self, pretrained_model, num_class, fine_tune):
        super(BanglaBERT2, self).__init__()
        # print("jksadhfkjlsh",pretrained_model)
        self.bert = MyBanglaBert2.from_pretrained(pretrained_model)

from transformers import AutoTokenizer, AutoModel, XLMRobertaModel, XLMRobertaTokenizer
...
TOKENS = {
    "bert": {"START_SEQ": "[CLS]", "PAD": "[PAD]", "END_SEQ": "[SEP]", "UNK": "[UNK]"},
    "roberta": {"START_SEQ": "<s>", "PAD": "<pad>", "END_SEQ": "</s>", "UNK": "<unk>"},
}
...
MODELS = {
    ...
    "xlm-mlm-en-2048": (XLMRobertaModel, XLMRobertaTokenizer, 2048, "xlm"),
    "xlm-mlm-100-1280": (XLMRobertaModel, XLMRobertaTokenizer, 1280, "xlm"),
    ...
    "sagorsarker/bangla-bert-base": (AutoModel, AutoTokenizer, 768, "bert"),
}

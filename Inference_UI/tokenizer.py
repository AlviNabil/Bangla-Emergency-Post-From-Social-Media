...
# the training split defines the vocabulary; fetched from the dataset repo
# unless a local UI/data/train.csv is present
...
# fitted once at import; refitting per call rebuilt the whole 10k-feature space
